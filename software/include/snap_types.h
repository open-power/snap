...
#define SNAP_ADDRTYPE_HBM_P4            0x0104 /* card specific HBM Port 4 */
#define SNAP_ADDRTYPE_HBM_P5            0x0105 /* card specific HBM Port 5 */
#define SNAP_ADDRTYPE_HBM_P6            0x0106 /* card specific HBM Port 6 */
#define SNAP_ADDRTYPE_HBM_P7            0x0107 /* card specific HBM Port 7 */
