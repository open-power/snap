...
/*
 * SNAP HLS_FRAMES2GPU EXAMPLE
 *
 * Tasks for the user:
 *   mode 0 : initialise data frames into FPGA attached DDR
 *   mode 1 : push DDR frames in to unified memory for GPU process
 */

#include <string.h>
#include "ap_int.h"
#include "frames2gpu_hardware.H"
...
#pragma HLS INTERFACE s_axilite port=return bundle=ctrl_reg
	...
	case 0:
		Action_Config->action_type = FRAMES2GPU_ACTION_TYPE;
