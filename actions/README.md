...
This subdirectory contains a number of SNAP action examples. Each example consists of an application running on the host and an associated action being exectuted on the FPGA. There are two HDL based examples and multiple HLS written examples.  
