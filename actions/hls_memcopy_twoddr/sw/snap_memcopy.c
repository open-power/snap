...
static void usage(const char *prog)
{
	printf("Usage: %s [-h] [-v, --verbose] [-V, --version]\n"
	       ...
	       "  -A, --type-in <HOST_DRAM,  CARD_DRAM, CARD_DRAM2, UNUSED, ...>.\n"
	       "  -a, --addr-in <addr>       address e.g. in CARD_RAM.\n"
	       "  -D, --type-out <HOST_DRAM, CARD_DRAM, CARD_DRAM2, UNUSED, ...>.\n"
	       ...
	       "  - CARD_DRAM/CARD_DRAM2 is the FPGA generally DDR attached memory\n"
