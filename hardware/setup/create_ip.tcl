...
#create fifo_10x512
# 
create_ip -name fifo_generator -vendor xilinx.com -library ip -version 13.* -module_name fifo_10x512 -dir $ip_dir
...
generate_target {instantiation_template}     [get_files $ip_dir/fifo_10x512/fifo_10x512.xci]
generate_target all                          [get_files $ip_dir/fifo_10x512/fifo_10x512.xci]
export_ip_user_files -of_objects             [get_files $ip_dir/fifo_10x512/fifo_10x512.xci] -no_script -force -quiet
export_simulation -of_objects [get_files $ip_dir/fifo_10x512/fifo_10x512.xci] -directory $ip_dir/ip_user_files/sim_scripts -force -quiet

#create fifo_8x512
# 
create_ip -name fifo_generator -vendor xilinx.com -library ip -version 13.* -module_name fifo_8x512 -dir $ip_dir
...
generate_target {instantiation_template}     [get_files $ip_dir/fifo_8x512/fifo_8x512.xci]
generate_target all                          [get_files $ip_dir/fifo_8x512/fifo_8x512.xci]
export_ip_user_files -of_objects             [get_files $ip_dir/fifo_8x512/fifo_8x512.xci] -no_script -force -quiet
export_simulation -of_objects [get_files $ip_dir/fifo_8x512/fifo_8x512.xci] -directory $ip_dir/ip_user_files/sim_scripts -force -quiet
