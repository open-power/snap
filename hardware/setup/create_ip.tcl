...
puts "	                     gernerating IP ram_520x64_2p"
...
puts "	                     gernerating IP ram_584x64_2p"
...
#create fifo_513x512
puts "	                     gernerating IP fifo_513x512"
...
if { $ddri_used == TRUE } {
  ...
  puts "	                     gernerating IP axi_clock_converter"
