...
if { ($fpga_card == "N250SP") && ($psl_ip_dir != "not defined") } {
  ...
  set_property used_in_simulation false [get_files $ip_dir/pcie4_uscale_plus_0/pcie4_uscale_plus_0.xci] -force >> $log_file
  # add  
  ...
  set_property used_in_simulation false [get_files $ip_dir/psl_bsp_clk_wiz/psl_bsp_clk_wiz.xci]         -force >> $log_file
  # add P9 PSL IP 
  ...
  set_property used_in_simulation false [get_files $ip_dir/PSL9_WRAP_0/PSL9_WRAP_0.xci]                 -force >> $log_file 
