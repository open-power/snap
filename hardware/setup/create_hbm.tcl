...
#connect_bd_net $port [get_bd_pins reset300_sync_inst/in_resetn]
...
connect_bd_net [get_bd_pins refclk_bufg_inst/BUFG_O] [get_bd_pins hbm/AXI_00_ACLK]
connect_bd_net [get_bd_pins refclk_bufg_inst/BUFG_O] [get_bd_pins hbm/AXI_02_ACLK]
...
#connect_bd_net [get_bd_pins refclk_bufg_div3/BUFGCE_O] [get_bd_pins hbm/HBM_REF_CLK_1]
...
#connect_bd_net [get_bd_pins refclk_bufg_div4_inst/BUFGCE_O] [get_bd_pins reset75_sync_inst/clk]
#connect_bd_net [get_bd_pins refclk_bufg_div4/BUFGCE_O] [get_bd_pins hbm/APB_1_PCLK]
...
connect_bd_net [get_bd_pins ARESETN] [get_bd_pins axi_512_to_256_15/s_axi_aresetn]
connect_bd_net [get_bd_pins ARESETN] [get_bd_pins axi_512_to_256_23/s_axi_aresetn]
connect_bd_net [get_bd_pins ARESETN] [get_bd_pins axi4_to_axi3_15/aresetn]
connect_bd_net [get_bd_pins ARESETN] [get_bd_pins axi4_to_axi3_23/aresetn]
#connect_bd_net [get_bd_pins ARESETN] [get_bd_pins hbm/AXI_15_ARESET_N]
#connect_bd_net [get_bd_pins ARESETN] [get_bd_pins hbm/AXI_23_ARESET_N]
connect_bd_net [get_bd_pins ARESETN] [get_bd_pins hbm/AXI_00_ARESET_N]
connect_bd_net [get_bd_pins ARESETN] [get_bd_pins hbm/AXI_02_ARESET_N]
...
connect_bd_intf_net [get_bd_intf_pins axi4_to_axi3_15/M_AXI] [get_bd_intf_pins hbm/SAXI_02]
connect_bd_intf_net [get_bd_intf_pins axi4_to_axi3_23/M_AXI] [get_bd_intf_pins hbm/SAXI_00]
...
connect_bd_net [get_bd_pins logic0_inst/dout] [get_bd_pins refclk_bufg_div3/BUFGCE_CLR]
connect_bd_net [get_bd_pins logic1_inst/dout] [get_bd_pins refclk_bufg_div3/BUFGCE_CE]
connect_bd_net [get_bd_pins logic0_inst/dout] [get_bd_pins refclk_bufg_div4/BUFGCE_CLR]
connect_bd_net [get_bd_pins logic1_inst/dout] [get_bd_pins refclk_bufg_div4/BUFGCE_CE]
...
set seg_range [get_property RANGE [get_bd_addr_segs hbm/SAXI_00/HBM_MEM00]]
...
set num_seg [expr 0x20000000 / $seg_range]
...
#    create_bd_addr_seg -range $seg_range -offset [expr $i * $seg_range] [get_bd_addr_spaces S_AXI_0] [get_bd_addr_segs "hbm/${interface}/HBM_MEM00"] "SEG_hbm_HBM_MEM00"
#  } else {
#    set interface {SAXI_02}
...
#    create_bd_addr_seg -range $seg_range -offset [expr $i * $seg_range] [get_bd_addr_spaces S_AXI_1] [get_bd_addr_segs "hbm/${interface}/HBM_MEM02"] "SEG_hbm_HBM_MEM02"
#  }
#}
assign_bd_address
#Slave segment </hbm/SAXI_02/HBM_MEM00> is being mapped into address space </S_AXI_0> at <0x0000_0000 [ 256M ]>
#Slave segment </hbm/SAXI_00/HBM_MEM00> is being mapped into address space </S_AXI_1> at <0x0000_0000 [ 256M ]>
#Slave segment </hbm/SAXI_02/HBM_MEM01> is being mapped into address space </S_AXI_0> at <0x1000_0000 [ 256M ]>
#Slave segment </hbm/SAXI_00/HBM_MEM01> is being mapped into address space </S_AXI_1> at <0x1000_0000 [ 256M ]>
#Slave segment </hbm/SAXI_02/HBM_MEM02> is being mapped into address space </S_AXI_0> at <0x2000_0000 [ 256M ]>
#Slave segment </hbm/SAXI_00/HBM_MEM02> is being mapped into address space </S_AXI_1> at <0x2000_0000 [ 256M ]>
#Slave segment </hbm/SAXI_02/HBM_MEM03> is being mapped into address space </S_AXI_0> at <0x3000_0000 [ 256M ]>
#Slave segment </hbm/SAXI_00/HBM_MEM03> is being mapped into address space </S_AXI_1> at <0x3000_0000 [ 256M ]>
