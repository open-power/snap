...
if { $create_clock_conv == "TRUE" } {
  ...
  if { ($sdram_used == "TRUE") && ( $fpga_card == "ADKU3" || $fpga_card == "S121B" || $fpga_card == "AD8K5" || $fpga_card == "S241"|| $fpga_card == "U200"|| $fpga_card == "U50" || $fpga_card == "AD9V3" || $fpga_card == "AD9H3" || $fpga_card == "AD9H7") } {
...
#https://github.com/Xilinx/XilinxBoardStore/blob/2019.2/boards/Xilinx/au200/1.3/preset.xml#L8-L27
